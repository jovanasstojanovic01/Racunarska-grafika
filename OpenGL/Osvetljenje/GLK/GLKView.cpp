...
{
	if (nChar == VK_RIGHT) m_glRenderer.incrementBeta(-5); // strelica desno
	else if (nChar == VK_LEFT) m_glRenderer.incrementBeta(5); // strelica levo
	else if (nChar == VK_UP) m_glRenderer.incrementAlpha(5); // strelica gore
	else if (nChar == VK_DOWN) m_glRenderer.incrementAlpha(-5); // strelica dole
	else if (nChar == 'R') m_glRenderer.toggleRedLight(); // r
	else if (nChar == 'G') m_glRenderer.toggleGreenLight(); // g
	else if (nChar == 'B') m_glRenderer.toggleBlueLight(); // b
	else if (nChar == 'N') m_glRenderer.toggleNormals(); // n
	else {
